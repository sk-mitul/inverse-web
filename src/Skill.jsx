...
function Skill() {
  return (
    <section
      id="skill"
      className="mx-auto max-w-326.25 px-3.75 lg:pt-0 py-7.5 lg:mb-22.5"
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7.5">
        {/* Design Column */}
        <div>
          <h2 className="font-bold text-[32px] leading-10.5 whitespace-nowrap">Design Skill</h2>
        ...
        {/* Development Column */}
        <div>
          <h2 className="font-bold text-[32px] leading-10.5">
            Development Skill
          </h2>
